...
class Laporan extends CI_Controller{
	...
	function pelunasan_piutang(){
		if ( $this->session->userdata('login') == 1) {
		    ...
		    $data['data'] = $this->query_builder->view("SELECT b.gudang_nama AS gudang, a.penjualan_nomor AS nomor, a.penjualan_grandtotal AS total, a.penjualan_tanggal AS pelunasan FROM t_penjualan AS a JOIN t_gudang AS b ON a.penjualan_gudang = b.gudang_id WHERE a.penjualan_hapus = 0 AND a.penjualan_pelunasan != '' AND a.penjualan_pelunasan = '$filter'");
