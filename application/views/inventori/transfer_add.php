        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Nomor Transfer Stok</label>
              <input type="text" name="nomor" class="form-control" required id="nomor">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label>Tanggal Transfer Stok</label>
        ...
        <table class="table table-responsive table-borderless">
          <thead>
            <tr>
              ...
              <th width="180">Stok ( MF )</th>
              <th width="300">Gudang Tujuan</th>
              <th width="200">Qty</th>
          ...
          <tbody id="paste">
             ...
             <tr id="copy">
              ...
              <td>
                <select required id="gudang" class="gudang form-control" name="gudang[]">
                  <option value="" hidden>-- Pilih --</option>
                  <?php foreach ($gudang_data as $j): ?>
                    <option value="<?=@$j['gudang_id']?>"><?=@$j['gudang_nama']?></option>
                  <?php endforeach ?>
                </select>
              </td>
...
//atribut
$('form').attr('action', '<?=base_url('inventori/transfer_save')?>');
$('#nomor').val('<?=@$nomor?>');
   ...
   /////// cek exist barang ///////////
    ...
    if (id != '') {
      ...
      if ($.inArray(id, arr) != -1) {
        ...
        $.get('<?=base_url('inventori/pewarnaan_get_produk/')?>'+id, function(data) {
